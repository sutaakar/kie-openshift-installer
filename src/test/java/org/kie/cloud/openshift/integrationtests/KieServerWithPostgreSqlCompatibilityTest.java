...
public class KieServerWithPostgreSqlCompatibilityTest extends AbstractCloudTest{

    private static final String KIE_SERVER_TEMPLATE_URL = System.getProperty("template.kieserver-postgresql.url");
    ...
    public void testKieServerMySqlTemplateCompatibility() throws MalformedURLException {
        ...
        PostgreSqlDeployment postgreSql = KieOpenShiftProvider.createPostgreSqlDeploymentBuilder("${APPLICATION_NAME}-postgresql")
                                                              ...
                                                              .withMaxPreparedTransactionsFromProperties()
